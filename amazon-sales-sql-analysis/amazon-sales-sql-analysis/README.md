...
├── SQL_Queries.sql                <-- A single file containing all query code for PgAdmin
├── data/
│   └── Amazon Sale Report.csv     <-- Original data
├── results/                       <-- CSV outputs of the queries
└── visualizations/                <-- PNG/JPEG images of supporting charts
```
